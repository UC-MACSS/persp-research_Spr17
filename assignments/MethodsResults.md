...
* Include the major components of these sections as covered previously by Dr. Evans. In no particular order (but follow an order that makes sense for your paper):
...
* A PDF of this document should be available in the `MethodsResults` folder in your repo by **11:30am on Wednesday, May 17th**
